...
{
public:
	Transform() : translation(0.0f), rotation(glm::vec3(0.0f)), qrotation(glm::vec3(0.0f)), scale(1.0f) {}
	Transform(const glm::vec3& translation, const glm::vec3& rotation = glm::vec3(0.0f), const glm::vec3& scale = glm::vec3(1.0f))
		: translation(translation), rotation(rotation), qrotation(rotation), scale(scale) {}
	...
	inline operator glm::mat4 () const
	{
		...
		glm::mat4 rotation_matrix = glm::mat4_cast(qrotation);
	...
	inline Transform& operator = (const glm::mat4& matrix)
	{
		...
		qrotation = glm::quat_cast(matrix);
